...
const welcomeChannelName = "g";
const byeChannelName = "안녕히가세요";
const welcomeChannelComment = "님 어서오세요 \n\nGamChang 디스코드 채널에 오신걸 환영합니다.\n\n꼭 공지사항 및 법전을 읽어 주신 후에, 이용 부탁드립니다.\n봇 개발자 이외에는 봇 추가 권한을 드리지 않습니다.";
const byeChannelComment = "안녕히가세요.";

client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '!도움 > 도움말 확인' }, status: 'online' })
});
...
client.on("guildMemberAdd", (member) => {
  ...
  member.addRole(guild.roles.find(role => role.name == "타우니국민"));
});
